...
문단 1 — 이름의 기운: 이름 한자 각각의 뜻과 소리가 어우러져 만들어내는 전체적인 기운과 이미지를 설명하세요. 절대 금지: "아기의 이름은", "이라는 이름은" 형식의 표현을 문단 어디에도 사용하지 마세요.
...
문단 4 — 부모의 마음과 덕담: 이 이름이 삶에서 어떤 빛이 될지, 이름에 담긴 소망과 기운이 앞날에 어떻게 펼쳐질지를 서술하세요. 단, 아래 표현은 절대 사용하지 마세요.
- "OOO이라는 이름은", "이 이름은" 형식으로 시작하는 문장
