...
[작성 형식]
아래 3개 문단으로 구성하세요. 문단 제목은 붙이지 말고 자연스러운 문장으로만 쓰세요. 문단 사이는 반드시 빈 줄 하나로 구분하세요. 각 문단은 3~4문장으로 작성합니다.

문단 1 — 이름의 기운: 이름 한자 각각의 뜻과 소리가 어우러져 만들어내는 전체적인 기운과 이미지를 설명하세요. 절대 금지: "아기의 이름은", "이라는 이름은", "OOO(OO)이라는 이름은" 등 이름을 주어로 내세워 소개하는 형식의 표현을 문단 어디에도 사용하지 마세요. 이름을 언급할 때는 한자 뜻 설명의 일부로 자연스럽게 녹여주세요.

문단 2 — 사주 특성: 사주팔자에서 드러나는 타고난 기질과 강점, 오행 분포가 보여주는 성격적 특성을 서술하세요. "아이의"라는 표현은 사용하지 마세요.
